  ...
  return (
    ...
    className='flex flex-col p-6 md:pt-12 font-sans' id='services'>
      ...
      <div className='flex flex-col md:grid md:grid-cols-3 gap-2 px-4 py-10 md:px-16'>
        {serviceData.map((n) => (
          <div class="max-w-sm bg-black rounded-lg border shadow-md border-">
            <div className='flex items-center justify-center pt-6'>
            ...
            <div class="p-5 items-center ">
                ...
                <Link to="#cta" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-black bg-white rounded-lg hover:bg-textGrey">
                  Get Updates 
