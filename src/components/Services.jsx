    ...
    className='flex flex-col' id='services'>
      ...
      <div className='flex flex-col md:grid md:grid-cols-3 gap-2 px-4 py-10 md:px-16'>
        <div class="max-w-sm bg-gray-800 rounded-lg border shadow-md border-gray-700">
          ...
          <div class="p-5">
              <a href="#">
                  <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-90 text-white">Global Delivery</h5>
              </a>
              <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">In order to bring our vision to life, we have optimized our delivery process to ensure we handle and deliver your products in the safest and fastest way possible.</p>
